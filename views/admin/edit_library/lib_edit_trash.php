	...
	<div class="col-mid-inner">
		<div class="col-top">
			<div class="col-top-inner">
				<h3>Корзина</h3>
				<div class="buttons">
					<a class="btn" href="#"><i class="icon-question-sign icon-white"></i> Помощь</a>
				</div>
			</div>
		</div><!-- end .col-top -->
		...
		<div class="col-bottom">
			<div class="col-bottom-inner">
				<button id="remove_images_trash" class="btn btn-large">Удалить выбранные</button>
				<button id="restore_images_trash" class="btn btn-large btn-orange">Восстановить</button>
	...
	$('#remove_images_trash').mouseup(function remove_images() {
		...
		$gallery.children('li').each(function()
		{
			if ($(this).hasClass('selected'))
			{
				...
				{
					array_images_all.push($(this).attr('id'));
				} else
				{
