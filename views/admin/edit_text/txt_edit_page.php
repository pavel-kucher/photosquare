			...
			<div class="col-top">
				<div class="col-top-inner">
					...
					<div class="buttons">
						...
						<a class="btn" href="#HelpEditPage"><i class="icon-question-sign icon-white"></i> Помощь</a>
					</div>
				</div>
			</div><!-- end .col-top -->
			...
			<form action="<?=URL.'admin/save_page_edits/'.$this->page['id_doc'];?>" onsubmit="return save_page_edits(this);" method="post">
				...
				<div class="col-bottom">
					<div class="col-bottom-inner">
						<input class="btn btn-large btn-orange" type="submit" value="Сохранить изменения" name="send" />
		...
		<div class="modal-footer">
			<div class="modal-footer-inner">
				<div class="pull-right">
					...
					<a class="m-btn btn-large btn-orange" href="#">Сохранить настройки</a>
				</div>
			</div>
		</div>
	</div><!-- end .modal-body -->
